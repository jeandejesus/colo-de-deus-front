...
export const EVENT_ROUTES: Routes = [
  ...
  { path: 'my-event/:id/qr', component: UserEventQRCodeComponent }, // específico
  { path: 'create', component: EventFormComponent },
  { path: 'edit/:id', component: EventFormComponent },
  { path: ':id/register', component: EventRegisterComponent }, // genérico, mas ainda específico
  { path: ':id', component: EventDetailComponent }, // sempre por último
];
